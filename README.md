...
🌐 **Deploy:** https://fintrack-ez4y.onrender.com
...
- [SQLite3](https://www.sqlite.org/) — desenvolvimento
...
## 🧪 Testes
O projeto conta com testes de integração cobrindo todas as rotas da API.
...
├── test/
│   └── transactions.test.ts # Testes de integração
├── .env.example
├── knexfile.ts
├── package.json
└── tsconfig.json
...
[LinkedIn](https://linkedin.com/in/lukas-barbosa-oliveira) • [GitHub](https://github.com/barbosalukas)